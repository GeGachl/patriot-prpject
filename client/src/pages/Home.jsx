            ...
            <div className="hp-content-inner">
              ...
              <div className="hp-description">
                ...
                <div className="hp-description-text">
                  ...
                  <p>
                    Хроники патриотизма — открытый цифровой архив документальных фильмов с подробными карточками, источниками и контекстными заметками. Проект упрощает поиск и просмотр исторических материалов, привлекает сообщество для уточнения данных.
                  </p>
                </div>
              </div>
                ...
                {films.map((f, i) => (
                  ...
                  >
                    <div className="hp-film-media">
                      <img
                        src={f.poster1 || "/posters/placeholder.jpg"}
                        alt={f.title}
                      />
                    </div>
